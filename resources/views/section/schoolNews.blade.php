...
@section('content')
        ...
        <div class="mainContent withImage">
            <div class="imageHeader" style="padding-bottom: 0px;">
                <div class="container">
                    <h1 class="pageTitle text-dark">{{ __('message.news') }}</h1>
                    <nav aria-label="breadcrumb">
                        <ol id="w5" class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('index') }}">{{ __('message.home') }}</a></li>
                            <li class="breadcrumb-item " aria-current="page">{{ __('message.news') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="container">
                <div class="navigationTabs">
                    <a href="/uz/news/index" class="active" data-tab="tab1">
                        <i class="fas fa-newspaper"></i> {{ __('message.news') }}
                    </a>
                    <a href="/uz/announces/index" class="active" data-tab="tab2">
